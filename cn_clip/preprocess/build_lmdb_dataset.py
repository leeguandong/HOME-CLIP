...
def parse_args():
    ...
    parser.add_argument(
        "--data_dir", type=str, default=r'E:\common_tools\Chinese-CLIP-master\dataset\furnitures',
        help="the directory which stores the image tsvfiles and the text jsonl annotations"
    )
    parser.add_argument(
        "--splits", type=str, default='train,valid', help="specify the dataset splits which this script processes, concatenated by comma \
            (e.g. train,valid,test)"
    )
    parser.add_argument(
        "--lmdb_dir", type=str, default=r'E:\common_tools\Chinese-CLIP-master\dataset\furnitures', help="specify the directory which stores the output lmdb files. \
